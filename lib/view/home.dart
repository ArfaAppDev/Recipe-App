...
import 'package:recipe_app/model/recipe.api.dart';
import 'package:recipe_app/model/recipe.dart';
import 'package:recipe_app/view/recipe_card.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Recipes App ",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 25),),
      ),
      body: isLoading
          ? const Center(
